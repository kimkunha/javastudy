...
public class UseFlowLayout  extends Frame{		//FlowLayout의 대표적인 예 : 탐색기
	
	public UseFlowLayout() {
		super("FlowLayout 연습");
		//2. 일반 컴포넌트의 생성
		Label lblname=new Label("이름");
		TextField tfname=new TextField(10);	//10은 보여줄 글자수
		...
		Checkbox cb1=new Checkbox("취미", false);

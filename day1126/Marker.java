 ...
 * 동사적 특징 : 쓴다 -&gt; method <br>
 * 사용법)<br>
 * 기본생성자를 사용하여 객체를 생성한 후 Setter Method를 호출하여 값을 설정한 후 사용한다. Marker m = new
 * Marker();<br>
 * m.setXxx(값);<br>
 *
 *
...
public class Marker {
	...
	/**
	 * 기본생성자로 마카펜 객체가 생성되면 검은색, 뚜겅1개, 몸체1개인 마카펜 객체를 생성합니다.<br>
	 * 11-26-2018 코드 추가
	 */
	public Marker() {
		this("검은색",1,1);	// 인자있는 생성자를 호출하여 값 설정. (중복코드를 줄일수 있다)
...
//		cap = 3;
	...
	/**
	 * 인자 있는 생성자 - 검은색, 뚜껑과 몸체가 1개가 아닌 마카펜을 생성할때 사용하는 생성자.<br>
	 * 색, 뚜겅의 수, 몸체의 수를 입력받아 마카펜을 생성하는 생성
	 * 
	 * @param color 마카펜의 색
	 * @param cap   마카펜의 뚜껑
	 * @param body  마카펜의 몸체

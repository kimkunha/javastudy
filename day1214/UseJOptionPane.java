...
public class UseJOptionPane extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(ae.getSource()==btn2) {
			JOptionPane.showMessageDialog(this, "오늘은 금요일 입니다.","요일안내",JOptionPane.INFORMATION_MESSAGE);
		}//end if
		...
		if(ae.getSource()==btn3) {
			...
			case JOptionPane.NO_OPTION :
				String menu=	JOptionPane.showInputDialog("어떤점심 메뉴였어요?");

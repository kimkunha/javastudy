...
//	private LunchMainView lmv;
	...
	public LunchAddView(LunchMainView lmv, LunchMainController lmc) {
		super(lmv,"도시락 추가 정보",true);	  //내 부모는 lmv, 모달로 준다  왜 부모임?
//		this.lmv=lmv;
		//DB에서 조회한 결과를 coponent에서 채운다.
		...
		jspTaSpec.setBounds(340, 125, 185, 140);
		
		jbAdd.setBounds(340, 285, 80, 30);
		jbEnd.setBounds(430, 285, 80, 30);
...
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // 이거 아님
		//다이얼로그를 종료할때에는 jFrame과다르게 DISPOSE_ON_CLOSE로 닫는다

...
public class SimpleClient {
	public SimpleClient() throws UnknownHostException, IOException {
		...
		//다른 컴퓨터에 들어갈때에는 ip adress 사용
		Socket client=null;
		//서버에세 보내오는 메세지를 읽기위한 스트림
		...
		System.out.println("서버의 메세지 : "+revMsg);
		JOptionPane.showMessageDialog(null,"서버의메세지 : "+client);
		
		//9. 서버로 데이터를 보내기 위한 스트림을 소켓에서부터 얻는다.
		String sendMsg="오늘은 수요일 입니다.";
